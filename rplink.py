    ...
    def rpilink(self):
        ...
        while self.go:
            ...
            if self.isonline:
                ...
                self.n=h.getnetdev()
                self.setlocaldata( {'msdid':self.d['msdid'], 'essid':self.d['essid'], 'coretemp':self.d['coretemp'], 'memavaiable':self.d['memavaiable'],'cpus':self.d['cpus'],'maxfreq':self.d['maxfreq'],'minfreq':self.d['minfreq']} )
